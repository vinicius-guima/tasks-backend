pipeline {
    ...
    post{
        always{
            junit allowEmptyResults:true , testResults 'target/surfire-reports/*.xml, api-test/target/surefire-reports/*.xml, functional-test/target/surefire-reports, functional-test/target/failsafe-reports'
        }
    }
}
